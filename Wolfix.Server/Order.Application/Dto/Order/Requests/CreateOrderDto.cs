...
public sealed record CreateOrderDto(string CustomerFirstName, string CustomerLastName, string CustomerMiddleName,
    ...
    string RecipientMiddleName, string RecipientPhoneNumber, string DeliveryMethodName, uint? DeliveryInfoNumber,
    string DeliveryInfoCity, string DeliveryInfoStreet, uint DeliveryInfoHouseNumber, DeliveryOption DeliveryOption,
