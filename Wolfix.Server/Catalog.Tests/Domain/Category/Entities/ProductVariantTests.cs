...
public sealed class ProductVariantTests
{
    ...
    {
        var result = ProductVariant.Create(null, key);
    ...
    {
        var result = ProductVariant.Create(null, "text");
    ...
    {
        var result = ProductVariant.Create(null, "text").Value.SetKey(key);
    ...
    {
        var result = ProductVariant.Create(null, "text").Value.SetKey("new text");
