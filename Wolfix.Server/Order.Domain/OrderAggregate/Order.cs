...
public sealed class Order : BaseEntity
{
    ...
    #region orderItems
    public VoidResult AddOrderItem(Guid productId, Guid sellerId, Guid cartItemId, string photoUrl, string title, uint quantity, decimal price)
    {
        ...
        Result<OrderItem> createOrderItemResult = OrderItem.Create(productId, sellerId, cartItemId, photoUrl, title, quantity, price, this);
